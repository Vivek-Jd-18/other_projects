...
function Home() {
  ...
  const web3ImageHAndler = async () => {
    // const element = document.getElementsByClassName("web3modal-provider-icon");
    // element.remove();

    // Create element:
    // const drd = document.getElementsByClassName("web3modal-provider-icon")
    // console.log("-=-=-=-=-=-=-=-==-=-=-=-=--",drd)
    // var img = document.createElement('img');
    // img.src =
    //   'https://media.geeksforgeeks.org/wp-content/uploads/20190529122828/bs21.png';
    // drd[0].appendChild(img);
  }
  web3ImageHAndler()
